    ...
    <footer role="contentinfo">
      <div className="relative bg-white border-t border-b border-black border-opacity-5">
        <div className="mx-auto max-w-7xl px-4 py-14 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            <h2 className="text-md font-medium uppercase mb-4">Communauté</h2>
            <ul className="mt-8 space-y-4">
              ...
              <li className="text-sm font-medium text-gray-600 hover:text-gray-900">
                <a
                  href="https://discord.gg/tdc49z4q"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center"
                >
           ...
           <div>
            <h2 className="text-md font-medium uppercase mb-4">Menu</h2>
            <ul className="mt-8 space-y-4">
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <Link to="/">Accueil</Link>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <Link to={`/collections/stickers`}>Stickers</Link>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <Link to={`/collections/objets-imprimes-en-3d`}>Objets imprimés en 3D</Link>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <Link to={`/collections/kits-delectronique`}>Kits d'électronique</Link>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
                <Link to={`/blogs/news`}>Articles</Link>
              </li>
              <li className="flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
